package com.company.surveillance.helpers;
...
public class OpenCVHelper {
    ...
    public static Mat bufferedImage2Mat(BufferedImage in)
    {
        ...
        if(in.getType() == BufferedImage.TYPE_INT_RGB || in.getType() == BufferedImage.TYPE_INT_ARGB || in.getType() == BufferedImage.TYPE_INT_ARGB_PRE)
        {
